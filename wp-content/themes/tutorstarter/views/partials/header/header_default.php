  ...
  <div class="container">
    <div class="row">
      <div class="header-top-left">
        <p>
          <span>
            <img src="https://trainyit.appszonebd.com/wp-content/uploads/2024/12/phone.png" alt="Phone Icon" width="20" height="20">
          </span>&nbsp; +880 1874 22 00 55
        </p>
        <p>
          <span>
            <img src="https://trainyit.appszonebd.com/wp-content/uploads/2024/12/email.png" alt="Email Icon" width="20" height="20">
          </span>&nbsp; support@trainyit.com
        </p>
      </div>
      <div class="header-top-right">
        <p> Admission <span>Going On</span>
        </p>
      </div>
    </div>
  </div>
</div>
<!--End Header Top Section- Zakir-->
				...
				<?php if ( true === get_theme_mod( 'cta_text_toggle', true ) ) { ?>
					<div class="utils-btn">
						<a class="btn-getstarted"
							href="<?php echo esc_url( get_theme_mod( 'cta_text_link', '#' ) ); ?>"><?php printf( esc_html__( '%s', 'tutorstarter' ), get_theme_mod( 'cta_text', 'Getting Started' ) ); ?></a>
					</div>
					<?php
				}
			}
